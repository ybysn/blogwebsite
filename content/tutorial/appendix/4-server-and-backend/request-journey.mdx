...
<div class="vue-demo-placeholder" data-demo="RequestJourneyFlow">
<p>📦 Interactive Demo: <strong>RequestJourneyFlow</strong></p>
...
<div class="vue-demo-placeholder" data-demo="RequestTimeline">
<p>📦 Interactive Demo: <strong>RequestTimeline</strong></p>
<p>This interactive visualization is not available in the static version.</p>
<a href="https://datawhalechina.github.io/easy-vibe/zh-cn/appendix/4-server-and-backend/" target="_blank" rel="noopener noreferrer" class="demo-original-link">🔗 View original interactive demo →</a>
</div>
