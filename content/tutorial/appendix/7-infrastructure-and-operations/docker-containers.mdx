...
<div class="vue-demo-placeholder" data-demo="DockerArchitecture">
<p>📦 Interactive Demo: <strong>DockerArchitecture</strong></p>
...
<div class="vue-demo-placeholder" data-demo="DockerLifecycle">
<p>📦 Interactive Demo: <strong>DockerLifecycle</strong></p>
<p>This interactive visualization is not available in the static version.</p>
<a href="https://datawhalechina.github.io/easy-vibe/zh-cn/appendix/7-infrastructure-and-operations/" target="_blank" rel="noopener noreferrer" class="demo-original-link">🔗 View original interactive demo →</a>
</div>
