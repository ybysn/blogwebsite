...
<div class="vue-demo-placeholder" data-demo="AiHelp">
<p>📦 Interactive Demo: <strong>AiHelp</strong></p>
...
4.  **安装插件**：在下拉菜单中选择 **“插件安装 (Extensions)”** 模式，体验如何在虚拟商店中安装 Python 插件。
  ...
  <div class="vue-demo-placeholder" data-demo="VirtualVSCode">
<p>📦 Interactive Demo: <strong>VirtualVSCode</strong></p>
<p>This interactive visualization is not available in the static version.</p>
<a href="https://datawhalechina.github.io/easy-vibe/zh-cn/appendix/2-development-tools/" target="_blank" rel="noopener noreferrer" class="demo-original-link">🔗 View original interactive demo →</a>
</div>
...
### 3.3 幕后流程：从代码到运行
  ...
  <div class="vue-demo-placeholder" data-demo="IdeArchitecture">
<p>📦 Interactive Demo: <strong>IdeArchitecture</strong></p>
<p>This interactive visualization is not available in the static version.</p>
<a href="https://datawhalechina.github.io/easy-vibe/zh-cn/appendix/2-development-tools/" target="_blank" rel="noopener noreferrer" class="demo-original-link">🔗 View original interactive demo →</a>
</div>
