...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image1.png)![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image2.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image3.png)![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image4.png)

- **在 Google 上通过关键词搜索配色**

![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image5.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image6.png)![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image7.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image8.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image9.png)

2. 回到设计页面，点击 **方块图标（插件）**。

![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image10.png)

3. 选中你想转换为代码的设计区域，点击 **Generate** 按钮生成代码。

![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image11.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image12.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image13.png)![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image14.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image15.png)

2. 然后在对话中告诉 Agent，将该文件中的内容应用到指定页面上。

![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image16.png)

3. 查看应用内容后的更新版本。

![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image17.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image18.png)![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image19.png)![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image20.png)

- **结果：**

![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image21.png)
...
![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image22.png)

- **结果：**

![](/tutorial/images/stage-1/appendix-articles/example0-2/images/image23.png)
