...
![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image1.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image2.webp)
...
- **提示词过程：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image3.webp)
- **贪吃蛇游戏效果：**

![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image4.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image5.webp)

- **价格：** 相对偏贵，但如果你有学校邮箱，可以通过学生验证以半价使用。
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image6.webp)
...
- **提示词过程：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image7.webp)
- **贪吃蛇游戏效果：**

![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image8.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image9.webp)

- **价格：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image10.webp)
...
- **提示词过程：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image11.webp)
- **贪吃蛇游戏效果：**

![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image12.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image13.webp)

- **价格：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image14.webp)
...
- **主要特性与工作流：** Replit 是一体化的在线开发与部署环境，浏览器里就可以写代码、运行程序、生成线上访问地址。开始编码前，它会给出清晰的行动计划；同时还提供可视化编辑器，你可以在预览窗口里直接改 UI，源码会自动同步更新。这样可以让你随时校验 AI 的输出是否符合预期，大幅减少来回修改的次数。
  ...
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image15.webp)
...
- **提示词过程：** 在构建过程中，AI 并不是一开始就完全理解需求，中间经历了大约 3 轮迭代，最终输出才达到了理想效果。
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image16.webp)
- **贪吃蛇游戏效果：**

![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image17.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image18.webp)

- **价格：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image19.webp)
...
![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image20.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image21.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image22.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image23.webp)

- **贪吃蛇游戏效果：**

![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image24.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image25.webp)

- **价格：** 免费版在复杂项目中很可能无法顺利从头跑到尾，因此更推荐付费升级，以确保项目可以完整构建。
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image26.webp)
...
- **提示词过程：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image27.webp)
- **贪吃蛇游戏效果：**

![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image28.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image29.webp)

- **价格：** 价格相对亲民，即便是免费版本，也足以完成质量不错的小项目。
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image30.webp)
...
- **提示词过程：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image31.webp)

  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image32.webp)

- **贪吃蛇游戏效果：**
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image33.webp)![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image34.webp)
- **价格：** 免费用户大约可以构建 4–5 个简单项目。
  ![](/tutorial/images/stage-1/appendix-articles/example0-1/images/image35.webp)
