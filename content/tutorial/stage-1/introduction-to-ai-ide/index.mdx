...
<a href="https://datawhalechina.github.io/easy-vibe/zh-cn/stage-1/introduction-to-ai-ide/" target="_blank" rel="noopener noreferrer" class="demo-original-link">🔗 View original interactive demo →</a>
</div>
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image1.png)![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image2.png)

终端界面（Terminal） 图片来源：https://en.wikipedia.org/wiki/File:Emacs-screenshot.png

知名且功能成熟的“内置 IDE”如 `Vim`，常用于服务器远程操作。

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image3.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image4.png)

VS Code 的核心理念是“一切皆插件”。它通过插件机制支持各种语言，安装 Python 插件就是 Python IDE，安装 C++ 插件就是 C++ IDE。不装插件时，它只是个高级文本编辑器。

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image5.png)

甚至可以用来编辑 Markdown 文档。

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image6.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image7.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image8.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image9.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image10.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image11.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image13.png)

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image14.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image17.png)

右侧的侧边栏就是 Copilot 交互窗口，也可以理解为 Agent 窗口。如果你暂时看不到它，可以点击 Trae 右上角的侧边栏图标将其打开。

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image18.png)

打开侧边栏之后，你会看到一个 `Builder` 选项，这就是 Agent 模式。简单理解，它相当于 z.ai 的“本地版”，可以帮你操作本机环境，安装运行环境、打开网页等。

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image19.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image20.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/image21.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-02-12-14-14-51.png)

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-02-12-14-15-29.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-52-55.png)

如图所示，这里我们只需要输入 y 即可确认：
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-53-24.png)

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-26-33.png)

如图所示，这里我们正在创建模板，但不知道如何操作，我们可以截图该部分对大模型进行询问：

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-29-12.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-30-51.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-33-37.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-42-53.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-44-36.png)
...
![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-49-33.png)

我们想要让本地的结果尽量符合 z.ai 的结果，我们可以复制这个 README 的全部内容，粘贴到 Trae 的侧边栏中，让他根据 README 的架构，修改本地的代码。

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-10-50-31.png)

最后我们能得到与 z.ai 高度相似的页面设计风格：

![](/tutorial/images/stage-1/introduction-to-ai-ide/images/index-2026-01-09-11-00-57.png)
...
<div class="tutorial-related-articles">
  ...
  <p>View the original tutorial for full navigation: <a href="https://datawhalechina.github.io/easy-vibe/zh-cn/stage-1/introduction-to-ai-ide/" target="_blank" rel="noopener noreferrer">https://datawhalechina.github.io/easy-vibe/zh-cn/stage-1/introduction-to-ai-ide/</a></p>
</div>
...
<div class="tutorial-card">
  ...
  <div class="flex flex-wrap">
    <div>
      <a href="#appendix-1-map"><b>附录一：常见计算机术语速查表</b></a><br/>
      <span>看到不懂的计算机名词时，来这里快速查含义，推荐通读一遍。</span>
    </div>
    <div>
      <a href="/zh-cn/appendix/2-development-tools/ide-basics"><b>附录二：Visual Studio Code 菜单栏解析</b></a><br/>
...
<div class="tutorial-card">
  ...
  <div class="flex flex-wrap">
    <div>
      <a href="#term-tool-ui">🖥️ <b>工具界面</b></a><br/>
      <span>IDE / 终端 / 面板</span>
    </div>
    <div>
      <a href="#term-network">🌐 <b>网络服务</b></a><br/>
      <span>URL / 端口 / 本地</span>
    </div>
    <div>
      <a href="#term-frontend-backend">⚙️ <b>前后端</b></a><br/>
      <span>API / JSON / 接口</span>
    </div>
    <div>
      <a href="#term-code-basic">📝 <b>代码基础</b></a><br/>
      <span>变量 / 函数 / 组件</span>
    </div>
  </div>
  <div class="flex flex-wrap">
    <div>
      <a href="#term-debug">🐞 <b>调试查错</b></a><br/>
      <span>Bug / 断点 / 日志</span>
    </div>
    <div>
      <a href="#term-project">📂 <b>项目管理</b></a><br/>
      <span>Git / 仓库 / 提交</span>
    </div>
    <div>
      <a href="#term-ai-tool">🤖 <b>AI 工具</b></a><br/>
      <span>Agent / 模型 / Key</span>
    </div>
    <div>
      <a href="#term-browser">🛠️ <b>浏览器</b></a><br/>
