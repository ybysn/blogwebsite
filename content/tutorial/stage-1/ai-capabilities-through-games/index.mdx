...
<a href="https://datawhalechina.github.io/easy-vibe/zh-cn/stage-1/ai-capabilities-through-games/" target="_blank" rel="noopener noreferrer" class="demo-original-link">🔗 View original interactive demo →</a>
</div>
...
![](/tutorial/images/stage-1/ai-capabilities-through-games/images/index-2026-01-07-18-25-03.png)
...
![](/tutorial/images/stage-1/ai-capabilities-through-games/images/index-2026-01-07-18-34-03.png)
...
![](/tutorial/images/stage-1/ai-capabilities-through-games/images/index-2026-01-07-18-35-11.png)

如果你想查看该网页的源代码，可以点击右上角的代码图标查看完整代码。

![](/tutorial/images/stage-1/ai-capabilities-through-games/images/image7.png)
...
> **💡 示例提示词：** 帮我做一个贪吃蛇游戏
>
> ![](/tutorial/images/stage-1/ai-capabilities-through-games/images/image12.png)

> **💡 示例提示词：** 帮我做一个贪吃蛇游戏，它应该支持
>
> 1. 我可以吃不同的单词，它们会被收集在一个盒子里
>    ![](/tutorial/images/stage-1/ai-capabilities-through-games/images/image13.png)
...
>
> ![](/tutorial/images/stage-1/ai-capabilities-through-games/images/image14.png)

注意，在开发过程中，我们可能会遇到不尽如人意的问题，例如点击按钮没有任何反应、使用功能时报错、功能未按预期工作，或者前端页面与预期设计不符。

在这种情况下，我们需要进一步向模型提问，以帮助修复这些意外问题。

![](/tutorial/images/stage-1/ai-capabilities-through-games/images/image15.png)
...
![](/tutorial/images/stage-1/ai-capabilities-through-games/images/image56.png)

我们可以使用这个提示词在全栈开发模式下重新生成项目：

![](/tutorial/images/stage-1/ai-capabilities-through-games/images/image57.png)

![](/tutorial/images/stage-1/ai-capabilities-through-games/images/image58.png)
...
<div class="tutorial-card">
  ...
  <div class="flex flex-wrap">
    <div>
      <a href="#appendix-1"><b>附录 1：我们需要前端开发知识吗？</b></a><br/>
      <span>搞清楚前端在整个应用里的位置，知道哪些是“看得见”的部分。</span>
    </div>
    <div>
      <a href="#appendix-2"><b>附录 2：到底什么是 Vibe Coding</b></a><br/>
      <span>理解“对话式开发”的核心思路，知道该如何和 AI 配合。</span>
    </div>
  </div>
  <div class="flex flex-wrap">
    <div>
      <a href="#appendix-3"><b>附录 3：模型上下文</b></a><br/>
      <span>搞清楚“上下文长度”这类常听到却又容易混淆的概念。</span>
    </div>
    <div>
      <a href="#appendix-4"><b>附录 4：指令遵循能力</b></a><br/>
...
![1767350588191](/tutorial/images/stage-1/ai-capabilities-through-games/images/1767350588191.png)
...
<div class="tutorial-related-articles">
  ...
  <p>View the original tutorial for full navigation: <a href="https://datawhalechina.github.io/easy-vibe/zh-cn/stage-1/ai-capabilities-through-games/" target="_blank" rel="noopener noreferrer">https://datawhalechina.github.io/easy-vibe/zh-cn/stage-1/ai-capabilities-through-games/</a></p>
</div>
