...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image1.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image2.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image3.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image4.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image5.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image6.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image7.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image8.webp)

其核心是将Bot构建简化为搭积木式操作。用户可通过界面轻松配置角色与知识库，并利用丰富的内置插件库为Bot添加新闻、旅游、图像生成等多类外部能力。创建好的Bot可一键快速发布至豆包、飞书、微信公众号等多个平台。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image9.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image10.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image11.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image12.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image13.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image14.webp)

在左侧找到 `CREATE APP` 区块，点击 `Create from Blank`。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image15.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image16.webp)

在 APP Type 中找到 Chatbot（如果一开始没看到，可以点击“查看更多类型”的按钮，然后在完整列表中找到）。选择 Chatbot 之后，在下方输入应用的名称和描述，最后点击创建。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image17.webp)

创建完成后，你会看到类似下面的界面。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image18.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image19.webp)

注意右上角会出现许多不同模型的选项，这意味着你可以点击切换不同的对话模型，从而比较它们在语气、逻辑推理、长文本处理等方面的差异，寻找最适合你需求的模型。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image20.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image21.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image22.webp)

进入插件市场后，搜索对应的插件名称即可。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image23.webp)

3. 安装结束后，我们能够配置支持新的模型供应商，在设置里的模型提供商部分，我们可以看到目前支持的所有模型商：
   ![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image24.webp)
4. 在开始使用前，需要先完成模型的配置。对于 OpenAI-API-compatible 插件，你可以点击 “Add Model” 来添加并配置任意模型。你可以在 “Model Type” 中选择该模型是LLM还是 Embedding，你需要确保模型的类型被正确配置。
   ...
   ![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image25.webp)

   对于 `SiliconFlow` 插件，只需要点击 Setup 配置 key 后即可使用 Embedding 和 Rerank 模型进行测试，你可以点击 Get you API Key from SiliconFlow 获得鉴权密钥。

   ![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image26.webp)

5. 配置完成后，你可以点击模型列表查看当前支持多少模型，此时已经完成了基础模型的全部配置。
   ![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image27.webp)

   其中支持了绝大部分常见的 Embedding 与 Rerank 模型：

   ![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image28.webp)

   此时如果你想要修改 Dify 默认使用模型的配置，你还可以点击 System Model Settings 按钮修改默认的所有模型。

   ![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image29.webp)

## 2.4 创建第一个 Dify 知识库

到这里，我们已经完成了最简单的 Agent 创建，但它还缺少一个知识库。现在，请点击顶部菜单中的 `Knowledge`，进入知识库创建页面。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image30.webp)

然后点击左侧的 `Create Knowledge`，创建你的第一个知识库。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image31.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image32.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image33.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image34.webp)

当所有设置完成后，点击 **Save & Process** ，系统就会进入知识库向量化阶段。在这一阶段，Embedding 模型会把切分后的文本转换为向量表示。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image35.webp)

处理完成后，点击 **Go to document** ，可以查看已经处理完毕并存储好的知识库内容。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image36.webp)

直接点击知识库名称，可以查看每个切片的具体内容。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image37.webp)

在这里，你可以对任意不合适的文本片段进行精确的编辑或删除操作。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image38.webp)

在左侧边栏中，选择 **Retrieval Testing** 可以对知识库进行召回测试，检查检索是否正常工作。每次测试会返回若干相似度最高的切片。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image39.webp)

如果你希望看到更多的切片结果，需要点击 `VECTOR SEARCH` 设置：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image40.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image41.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image42.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image43.webp)

此时，在每一轮对话中，你都可以在回答中看到被命中的知识库来源。点击对应条目即可查看检索到的具体文本片段。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image44.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image45.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image46.webp)

而对于工作流的导出，我们只需要点击单个工作流块的右下角即可找到导出按钮：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image47.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image48.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image49.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image50.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image51.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image52.webp)

同时，可以打开工具选择面板，查看支持调用的各类工具：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image53.webp)

下面是一些常用节点和工具的简要说明。不需要一次性全部掌握，建议先留个印象，在实际使用中逐步熟悉，必要时再回查阅。

1. LLM与推理节点

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image54.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image55.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image56.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image57.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image58.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image59.webp)

随后点击 Start 的 User Input 节点，定义一个名为 `user_text` 的字符串类型变量，作为整个流程的输入源。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image60.webp)

保存后点击右上角的 Test Run，你能够看到需要指定对应的文本输入进行处理：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image61.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image62.webp)

设定完成后，你可以在右上角的播放键单独测试该节点是否能够正常运行：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image63.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image64.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image65.webp)

接下来我们处理并行 LLM 的输出值，我们在 `Variable Aggregator` 节点的配置面板中，找到 `ASSIGN VARIABLES`（分配变量）区域，点击后依次将之前的大模型回复加入即可。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image66.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image67.webp)

最后加入 output 节点即完成所有操作：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image68.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image69.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image70.webp)

刚进入感觉十分复杂，没关系，我们点击右上角的 Preview 运行工作流，直到报错出现：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image71.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image72.webp)

我们需要根据报错的节点解决问题，打开后发现是没有配置 Tavily 的 API Token，Tavily 的搜索API 是一个专为 AI 设计的搜索引擎，提供实时、准确和事实性的结果。此时根据提示操作：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image73.webp)

经过处理后，搜索引擎能够正常工作：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image74.webp)

继续修正模型调用导致的问题后，你应该能够得到如下结果，结合大模型理解下的详细搜索：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image75.webp)

我们在最后能够看到对应的参考文档地址：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image76.webp)

如果你想理解每个环节的作用，最好的方法是将每个环节的 output 记录为一个变量，最后在输出的时候打印每个中间变量的结果，还有一个方法就是你可以在上方找到 Process 的过程，点击后可以查看每个环节的细节：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image77.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image78.webp)

右侧的区域叫做 Copilot 交互窗口，或者 Agent 窗口。如果你看不到它，可以点击右上角的侧边栏图标来打开。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image79.webp)

打开侧边栏后，你会看到 `Builder` 选项。这就是 Agent 模式。你可以简单地把 “Builder” 理解为 [z.ai](http://z.ai) 的“开发模式”，它同样可以帮你操作本地电脑环境、安装依赖、打开网页等。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image80.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image81.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image82.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image83.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image84.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image85.webp)

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image86.webp)

在找到会话所需的 Request 和 Response 示例之后，我们还需要获取一个 API Key。在文档右上角，你会看到 “API key” 相关选项。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image87.webp)

点击 “Create new Secret key”，就可以创建属于你自己的 API Key。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image88.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image89.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image90.webp)

此时浏览器是嵌在 Trae 内部的。你可以点击顶部的指南针图标，把网页在外部浏览器中全屏打开。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image91.webp)

如果运气不错，你可能在第一次尝试时就能获得一个可以正常交互的前端页面。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image92.webp)

不过，由于大模型本身具有一定随机性，有时你可能在单轮对话中一切顺利，但在多轮对话时出现异常。因此，建议你进行多轮对话测试，确保程序在多轮交互场景下也能稳定运行。

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image93.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image94.webp)

参考输入输出：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image95.webp)

3. Love loop workflow 工作流解密挑战

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image96.webp)

在这个解密挑战中，你需要修复当前工作流的问题，让工作流最后的输出类似如下显示：

![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image97.webp)
...
![](/tutorial/images/stage-2/ai-capabilities/dify-knowledge-base/images/image98.webp)
