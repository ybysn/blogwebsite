...
![](/tutorial/images/stage-2/backend/modern-cli/images/image1.png)![](/tutorial/images/stage-2/backend/modern-cli/images/image2.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image3.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image4.png)![](/tutorial/images/stage-2/backend/modern-cli/images/image5.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image6.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image7.png)![](/tutorial/images/stage-2/backend/modern-cli/images/image8.png)

![](/tutorial/images/stage-2/backend/modern-cli/images/image9.png)![](/tutorial/images/stage-2/backend/modern-cli/images/image10.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image11.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image12.png)

它还将上下文窗口扩展到 200K，可以更加从容地处理长文本和大体量代码，同时加强了推理与工具调用能力，在性能和成本之间取得了不错的平衡。

![](/tutorial/images/stage-2/backend/modern-cli/images/image13.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image14.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image16.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image17.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image18.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image19.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image20.png)

下面是 DeepSeek 与 Kimi 的配置示例：

![](/tutorial/images/stage-2/backend/modern-cli/images/image21.png)

![](/tutorial/images/stage-2/backend/modern-cli/images/image22.png)

保存模型配置后，还需要在右侧 Router 区域中指定默认模型（Default）。点击对应的下拉选择，将其设置为 `kimi`（推荐），然后在右上角点击 `Save and Restart`。

![](/tutorial/images/stage-2/backend/modern-cli/images/image23.png)

之后，只需在终端中输入 `ccr code`，即可通过 Claude Code Router 启动 Claude Code 的编码工作流。

![](/tutorial/images/stage-2/backend/modern-cli/images/image24.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image25.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image26.png)

![](/tutorial/images/stage-2/backend/modern-cli/images/image27.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image28.png)

![](/tutorial/images/stage-2/backend/modern-cli/images/image29.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image30.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image32.png)

![](/tutorial/images/stage-2/backend/modern-cli/images/image33.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image34.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image35.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image36.png)

这里以选择 OpenAI 为例,进行回车选择认证方式。

![](/tutorial/images/stage-2/backend/modern-cli/images/image37.png)

选哪种都可以,只是认证方式不同。这里选择第一种进行浏览器登录。

![](/tutorial/images/stage-2/backend/modern-cli/images/image38.png)

复制此链接到浏览器上进行正常的 OpenAI 登录操作，浏览器上出现 Authorization Successful 后 OpenCode 客户端会自动跳转至选择 OpenAI 的模型界面。

![](/tutorial/images/stage-2/backend/modern-cli/images/image39.png)

![](/tutorial/images/stage-2/backend/modern-cli/images/image40.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image41.png)
...
![](/tutorial/images/stage-2/backend/modern-cli/images/image31.png)
