...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image1.png)

在能力层面，它和你可能听说过的其他模型（如 GPT-4o、Claude、Qwen、Midjourney 等）并没有本质区别：**输入描述，模型负责生成结果。**

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image2.png)![](/tutorial/images/stage-2/frontend/lovart-assets/images/image3.png)![](/tutorial/images/stage-2/frontend/lovart-assets/images/image4.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image5.png)

2. 新建一个 Python 文件

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image6.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image7.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image8.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image9.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image10.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image11.png)![](/tutorial/images/stage-2/frontend/lovart-assets/images/image12.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image13.png)

在Output Image区域点击下载图片即可保存到本地。

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image14.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image15.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image16.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image17.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image18.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image19.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image20.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image21.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image22.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image23.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image24.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image25.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image26.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image27.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image28.png)![](/tutorial/images/stage-2/frontend/lovart-assets/images/image29.png)

这一步，AI 从“执行者”转变为“策划者”。在AI帮你分析完需求后，可以在Lovart的画布区看到多种风格和内容的程序员鸭子图片。可以开始筛选你喜欢的风格。

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image30.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image31.png)

* 输入新的动作（如开心）并生成

生成结果会继承母版的配色、比例和细节。

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image32.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image33.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image34.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image35.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image36.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image37.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image38.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image39.png)

这些并不是简单滤镜，而是 Agent 自动调度不同工具完成的结果。

而在确定完基调风格后，可以很快速的生成一系列的表情包图像。

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image40.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image41.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image42.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image43.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image44.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image45.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image46.png)

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image47.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image48.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image49.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image50.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image51.png)

3. 直接绘图指令，这里输入的是“我要画一只猫”，同样检测准确。

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image52.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image53.png)

除了修改底层代码，我们在网页上也可以快速编辑。举个例子，我在这里加了一句，“在前面加一句Pic Prompt”，可以看到生成的新的提示词前面也包含了～这样设计是为了方便快速修改生成提示词的System Prompt，帮助我们快速切换风格。

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image54.png)
...
![](/tutorial/images/stage-2/frontend/lovart-assets/images/image55.png)

太令人激动啦！我们终于顺利地生成出了这个Agent的第一张图，仔细看看生成的图片，跟我们的文本和提示词是匹配的。到这里你已经基本上实现你自己的Agent啦！

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image56.png)

我们还添加了图生图功能，上传你喜欢的图片，AI会自动借鉴风格。

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image57.png)

值得一提的是，前面步骤生成的提示词也是可以在网页上编辑的，并且我们是以最终点击按钮时的提示词为准～哪怕我在这里换成“a cute cat”，最终生成的图片也只会是可爱的小猫。

## 第 4 章：总结

![](/tutorial/images/stage-2/frontend/lovart-assets/images/image58.png)
