...
![](/tutorial/images/stage-2/frontend/design-to-code/images/image42.webp)
...
![](/tutorial/images/stage-2/frontend/design-to-code/images/image47.webp)
...
![](/tutorial/images/stage-2/frontend/design-to-code/images/image48.webp)

![](/tutorial/images/stage-2/frontend/design-to-code/images/image49.webp)

3. **获取代码**
   - 点击蓝色按钮"插入到画布"，可直接编辑生成后的网页
   - 或点击右侧的"代码"按钮，复制代码内容到本地

![](/tutorial/images/stage-2/frontend/design-to-code/images/image50.webp)
...
![](/tutorial/images/stage-2/frontend/design-to-code/images/image43.webp)

3. **查看生成结果**
   - 稍等片刻后即可看到渲染结果
   - 点击右上角的播放按钮可进行全屏预览

![](/tutorial/images/stage-2/frontend/design-to-code/images/image44.webp)

4. **细节调整**
   - 点击右上角的编辑器图标（鼠标和尺子图标）
   - 回到熟悉的 Figma Editor 界面进行详细调整

![](/tutorial/images/stage-2/frontend/design-to-code/images/image45.webp)

5. **导出代码**
   - 调整满意后，选择导出代码
   - 可以直接连接到 GitHub 保存代码

![](/tutorial/images/stage-2/frontend/design-to-code/images/image46.webp)
