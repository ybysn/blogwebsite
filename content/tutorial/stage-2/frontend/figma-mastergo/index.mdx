...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image8.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image9.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image10.webp)

二是 "量尺寸"：得用软件自带的测量工具，逐一确认每个元素的宽高、不同模块间的间距（margin/padding）等数据，确保所有尺寸都精准到像素；

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image11.webp)

三是 "抠标注"：要从设计图中提取那些 "看不见却必须有的" 隐性参数 —— 比如文字的字号、字重、行距，每个色块的 RGB 或 HEX 色值等，相当于把设计师没写在纸上的 "设计规格" 手动 "抠" 出来记录。

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image12.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image13.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image14.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image15.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image16.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image17.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image18.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image19.webp)
...
3. 画一个按钮雏形：
   ...
   ![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image20.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image21.webp)

### 2.4 善用 Auto Layout 整合元素

如果所有元素只是随手拖拽，页面很快会乱。Figma 里一个很重要的概念就是 **Auto Layout** ，它可以把一组元素变成一个带规则的容器。

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image22.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image23.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image24.webp)
...
2. 右键选择 Create component（创建组件）。
   ![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image25.webp)

这样，这个按钮就从一组普通图层，变成了一个组件母版。之后如果你在其他页面或 Frame 里需要同样风格的按钮，可以直接从左侧的 Assets 面板里拖出来使用。

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image26.webp)

此时所有用到的按钮，都是这个母版的同步拷贝。当你修改母版的颜色、圆角或间距时，所有实例都会自动保持同步更新。

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image27.webp)
...
1. **进入 MasterGo 后台**
   ...
   2. 进入后，你会看到类似「文件列表 / 项目列表」的首页区域，用来管理你的设计文件。
      ![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image28.webp)
...
3. **认识基本界面区块**
   ...
   ![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image29.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image30.webp)

### 3.3 创建画板内容

有了容器，使用与 Figma 中我们已教过的类似方式，很容易可以得到相似的展示页面。（你可以尝试复制 Figma 画板中的文字元素，能够支持文本组件的直接粘贴导入）

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image31.webp)

值得注意的是 Auto Layout 功能行为稍微的不一致性，在 MasterGo 中，如果你想实现和 Figma 相似的按钮长度随着文字的长度变化，你需要先在对应矩形元素的基础上创建一个容器或组件，如图所示：

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image32.webp)

成功创建容器后，将按钮矩形和文字放到对应并列的容器中，再在右侧找到 Auto Layout 的按钮启用自动功能，即可成功实现按钮宽度能够随着文字长度变化的功能。

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image33.webp)

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image34.webp)

### 3.4 AI 生成页面

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image35.webp)
...
![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image36.webp)

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image37.webp)

设计文档生成结束后，点击开始生成，稍作等待便能获取对应的实际网页效果：

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image38.webp)

此时你有两种操作选择：一是点击蓝色按钮将生成结果直接插入画布，二是点击代码预览功能，直接获取当前完整页面的代码，具体操作界面如下：

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image39.webp)

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image40.webp)

将结果插入画布后，你还能对网页的整体布局、元素细节（如字体、颜色、间距等）进行更精细的调整，直至最终效果完全符合你的预期。

![](/tutorial/images/stage-2/frontend/figma-mastergo/images/image41.webp)
