...
original_url: "https://datawhalechina.github.io/easy-vibe/zh-cn/stage-3/cross-platform/vscode-extension/"
---
...
![VS Code 插件生态示意图，展示插件可以扩展的各个区域：侧边栏、编辑器、状态栏、命令面板、Chat 面板](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image1.webp)
...
![VS Code 插件架构图，展示 Extension Host 进程与编辑器主进程的关系](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image2.webp)
...
![AI Project Bot 插件效果预览图，展示侧边栏模板列表、Chat 面板中的 @project-bot 对话、右键菜单](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image3.webp)
...
![package.json 文件在编辑器中的截图，高亮 contributes 字段](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image4.webp)
...
![VS Code 调试插件的截图，展示 Extension Development Host 窗口和 Hello World 消息](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image5.webp)
...
![VS Code 侧边栏中显示 AI Project Bot 图标和项目模板列表的截图](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image6.webp)
...
![点击模板后弹出项目名称输入框和文件夹选择对话框的截图](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image7.webp)
...
![VS Code Chat 面板中 @project-bot 对话的截图，展示 /explain 命令的使用和流式回复](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image8.webp)
...
![VS Code Chat 面板中 @project-bot 对话的截图，展示 /explain 命令的使用和流式回复](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image9.webp)
...
![资源管理器中多选文件后右键菜单显示 AI 分析选项的截图](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image10.webp)
...
![VS Code 状态栏中显示 AI Bot 图标的截图](/tutorial/images/stage-3/cross-platform/vscode-extension/images/image11.webp)
