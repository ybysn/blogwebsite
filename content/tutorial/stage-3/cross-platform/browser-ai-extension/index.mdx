...
![placeholder: 一张效果预览图，左边是一个长文章网页，右边是 Chrome 侧边栏中显示的 AI 生成的摘要](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image1.png)
...
```
![placeholder: 一张架构流程图，展示 Content Script、Service Worker、Side Panel 之间的消息传递关系](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image2.png)
...
![placeholder: manifest.json 文件在编辑器中的截图](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image2b.png)
...
![placeholder: Chrome 扩展管理页面的截图，展示如何开启开发者模式并加载插件](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image3.png)
...
![](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image4.png)
...
```
![placeholder: 侧边栏 UI 效果截图，展示总结按钮、加载状态和摘要结果三种状态](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image5.png)
...
![placeholder: 设置页面的截图，展示 AI 提供商选择和 API Key 输入框 p1](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image6-1.png)
![placeholder: 设置页面的截图，展示 AI 提供商选择和 API Key 输入框 p2](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image6-2.png)
![placeholder: 设置页面的截图，展示 AI 提供商选择和 API Key 输入框 p3](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image6-3.png)
...
![placeholder: chrome://flags 页面截图，展示 Summarization API 的开关位置](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image7.png)
...
![placeholder: 更新后的设置页面截图，展示三个 AI 提供商选项，选中 Chrome 内置 AI 时 API Key 输入框隐藏](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image8.png)
...
![placeholder: Chrome DevTools 调试插件的截图，展示如何选择不同的执行上下文来调试不同组件](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image9.png)
...
![placeholder: Chrome Web Store Developer Dashboard 的截图，展示插件上传和信息填写界面](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image10.png)
![placeholder: Chrome Web Store Developer Dashboard 的截图，展示插件上传和信息填写界面p2](/tutorial/images/stage-3/cross-platform/browser-ai-extension/images/image10-1.png)
