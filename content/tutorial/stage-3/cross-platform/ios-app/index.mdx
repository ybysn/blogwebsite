...
original_url: "https://datawhalechina.github.io/easy-vibe/zh-cn/stage-3/cross-platform/ios-app/"
---
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image1.webp)

### 1.1 iOS App

iOS App 是运行在 iPhone 操作系统上的原生应用程序，它启动速度快、交互流畅，并且可以深度使用通知、相机、本地存储等系统功能。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image2.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image3.webp)

第二种方式，是使用跨平台框架，例如 React Native、Flutter 等，通过一套代码适配多个平台。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image4.webp)

基于以上方式，本教程选择的是： **以 SwiftUI 原生开发为基础，结合 AI 工具完成主要编码工作** 。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image5.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image6.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image7.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image8.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image9.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image10.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image11.webp)

Xcode 可以直接在 App Store 中搜索并安装。安装完成后，首次打开会看到欢迎界面，后续创建项目将从这里开始。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image12.webp)

#### 2.2.2 Trae

Trae 是本教程中进行主要开发工作的环境。你会把整个 iOS 项目放在 Trae 中，通过对话的方式与 AI 协作完成开发。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image13.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image14.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image15.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image16.webp)

点击 **Next** ，选择项目存放位置。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image17.webp)

### 3.4 项目创建完成后的结构认识

项目创建完成后，Xcode 会自动打开工程。此时不需要理解所有文件，只需要认识几个关键点。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image18.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image19.webp)

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image20.webp)

如果一切正常，模拟器中会显示一个可以正常启动的空白 App。首次编译时间可能较长，后续章节中我们会通过 HTML 原型的方式减少编译等待。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image21.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image22.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image23.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image24.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image25.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image26.webp)

SiliconFlow 提供了兼容 OpenAI API 规范的接口，可以非常方便地在 iOS 项目中通过标准网络请求进行调用。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image27.webp)

在开始之前，你需要在官网注册账号并创建一个 API Key。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image28.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image29.webp)
...
3. 添加属性：
   ...
   7. `colorIndex`: **Integer 16**
      ![](/tutorial/images/stage-3/cross-platform/ios-app/images/image30.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image31.webp)![](/tutorial/images/stage-3/cross-platform/ios-app/images/image32.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image33.webp)

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image34.webp)

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image35.webp)

重新运行 App，你会看到一个完整、可识别的真实 iOS 应用。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image36.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image37.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image38.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image39.webp)

首次连接时，手机会弹出「是否信任此电脑」，选择信任并输入解锁密码。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image40.webp)

在 Xcode 的设备列表中，选择你的 iPhone，然后再次点击 ▶️ Run。

此时，你应该可以在手机桌面看到「冰箱大厨」的图标，并且可以正常打开和使用。

![](/tutorial/images/stage-3/cross-platform/ios-app/images/image41.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image42.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image43.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image44.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image45.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image46.webp)
...
![](/tutorial/images/stage-3/cross-platform/ios-app/images/image47.webp)
