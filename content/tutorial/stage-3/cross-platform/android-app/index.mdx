...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image1.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image2.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image3.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image4.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image5.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image6.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image7.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image8.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image9.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image10.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image11.png)

3. **加速依赖库下载**

接着，在左侧目录的根节点下找到并打开 `settings.gradle.kts` 文件。，请将 `repositories` 大括号内的内容替换为以下代码：

![](/tutorial/images/stage-3/cross-platform/android-app/images/image12.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image13.png)

4. **保存应用更改**

到了这一步我们记得保存一下，然后点击右上角的那个 `Try Again`，软件会重新开始下载配置。耐心等待几分钟，当底部控制台出现 `BUILD SUCCESSFUL`字样时，说明环境搭建彻底成功，我们已经准备好开始写代码了。

![](/tutorial/images/stage-3/cross-platform/android-app/images/image14.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image15.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image16.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image17.png)

在弹出的硬件选择窗口中，选择 “Phone”（手机） 分类下的 “Smart Phone”（中等屏幕手机） 选项（也可根据需求选择其他分辨率的设备，如 “Pixel” 系列），点击 “Next”。

![](/tutorial/images/stage-3/cross-platform/android-app/images/image18.png)

**第二步：配置系统镜像**

进入 “System Image”（系统镜像）对话框，在列表中选中 “API 36.1” 系统版本（若该版本未下载，右侧会显示 “Download”按钮，点击按钮下载镜像文件，下载完成后再选中），点击 “Finish”。

![](/tutorial/images/stage-3/cross-platform/android-app/images/image19.png)

**第三步：启动模拟器**

创建成功后，你的设备管理器列表中会出现刚刚添加的手机。点击它右侧的 **三角形播放按钮** 。 稍等片刻，一个外形像真实手机的窗口就会弹出来。这就是你的安卓模拟器。

![](/tutorial/images/stage-3/cross-platform/android-app/images/image20.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image21.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image22.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image23.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image24.png)

敲击音效下载链接 https://www.aigei.com/s?q=%E6%9C%A8%E9%B1%BC&type=sound，选择第一个1s的音效即可

![](/tutorial/images/stage-3/cross-platform/android-app/images/image25.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image26.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image27.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image28.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image29.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image30.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image31.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image32.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image33.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image34.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image35.png)

4. 运行设备：点击 ▶️ 运行

![](/tutorial/images/stage-3/cross-platform/android-app/images/image36.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image37.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image38.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image39.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image40.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image41.png)

### 4.1.3 打开手机开发者模式

打开手机设置，进入开发者选项，找到并开启 **【** **USB** **调试**】 开关。

![](/tutorial/images/stage-3/cross-platform/android-app/images/image42.png)

### 4.1.4 系统中安装Usb驱动

此时，拿起你的手机，屏幕上应该会弹出一个重要的安全警告框：“允许 USB 调试吗？”。 请务必勾选 “始终允许”，然后点击“允许”或“确定”。这是电脑获得手机控制权的关键授权。

![](/tutorial/images/stage-3/cross-platform/android-app/images/image43.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image44.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image45.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image46.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image47.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image48.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image49.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image50.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image51.png)

**第二步：创建数字密钥 (KeyStore)**

这是新手最容易卡住的地方。因为是第一次打包正式版，我们需要新建一个“密钥库”。 在 Key store path 下方点击 **Create new** 。

![](/tutorial/images/stage-3/cross-platform/android-app/images/image52.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image53.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image54.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image55.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image56.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image57.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image58.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image59.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image60.png)![](/tutorial/images/stage-3/cross-platform/android-app/images/image61.png)

![](/tutorial/images/stage-3/cross-platform/android-app/images/image62.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image63.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image64.png)
...
![](/tutorial/images/stage-3/cross-platform/android-app/images/image65.png)
