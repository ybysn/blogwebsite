...
![placeholder: 一张示意图，展示 Electron 的架构：Chromium（负责 UI 渲染）+ Node.js（负责系统访问）= 桌面应用](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image1.png)
...
![placeholder: 一张 Electron 进程架构图，展示 Main Process、Renderer Process、Preload Script 之间的关系和 IPC 通信](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image2.png)
...
![placeholder: 一张应用效果预览图，展示语音转文字应用的 UI：顶部有录音按钮和波形动画，下方是识别出的文字，右上角有模式切换开关](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image3.png)
...
![placeholder: Electron 应用首次启动的截图，展示默认的欢迎页面窗口](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image4.png)
...
![placeholder: 一张 IPC 通信流程图，展示 Renderer → Preload → Main 的消息传递过程](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image5.png)
...
```
![placeholder: 应用录音界面的截图，展示录音按钮（录音中状态，红色脉冲动画）和下方的文字显示区域](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image6.png)
...
```
![placeholder: 应用运行截图，展示用户说了一段中文后，Whisper API 返回的识别结果](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image7.png)
...
4. 点击面板外面的区域就能关闭面板
```
![placeholder: 设置面板展开的截图，展示模式切换开关和 API Key 输入框](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image8.png)
...
```
![placeholder: 本地模型识别的运行截图，展示离线状态下依然能正常识别中文语音](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image9.png)
...
打包产物在 `out/make/` 目录下。
![placeholder: out/make 目录的文件列表截图，展示生成的 .dmg 或 .exe 安装包](/tutorial/images/stage-3/cross-platform/electron-voice-to-text/images/image10.png)
