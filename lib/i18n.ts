...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'tools.description': 'A collection of handy dev tools — JSON, Base64, URL, UUID, timestamp, JWT, colors.',
    'tools.json': 'JSON Formatter',
    'tools.base64': 'Base64',
    'tools.url': 'URL Encode/Decode',
  ...
  'zh-CN': {
    ...
    'tools.description': '常用开发工具集 — JSON、Base64、URL、UUID、时间戳、JWT、颜色转换。',
    'tools.json': 'JSON 格式化',
    'tools.base64': 'Base64',
    'tools.url': 'URL 编解码',
    'tools.uuid': 'UUID 生成器',
    ...
    'tools.validate': '验证',
    'tools.generate': '生成',
    'tools.generateNew': '重新生成',
    'tools.validJson': '✓ JSON 有效',
    'tools.invalidJson': '✗ JSON 无效',
    'tools.clear': '清空',
    'tools.now': '当前时间',
  },
}
